<template>
  <v-container>
    <h3 class="font-weight-bold blue-grey--text text-center mt-3 mb-5">
      Daftar Tugas Yang Sudah Dikerjakan ( {{ items.length }} )
    </h3>
      ...
      <v-col lg="12">
        ...
        >
          <v-img
            ...
            height="400px"
            v-bind:src="require(`../assets/img/` + item.urlToImage)"
          >
          ...
          <v-card-actions class="d-flex justify-space-between pb-3 mb-10">
            ...
            <a href="https://github.com/dwirifki10" target="_blank">
    ...
    <div v-intersect="handleLoadMore" v-if="false"></div>
  </v-container>
</template>
